...
function initializeMapCounties() {
    ...
    Promise.all([
        ...
        d3.csv('data/US_Lightning_Forest_Fires.csv') // Your wildfire data
        ...
        // Group data by year
        dataByYear = d3.group(wildfireData, d => d.Year);

        // Get array of years and sort
        years = Array.from(dataByYear.keys()).sort();
        ...
        // Add the legend here, after colorScaleCounties is defined
    ...
    function updateMapCounties(year) {
        ...
        geojsonLayerCounties.eachLayer(function(layer) {
            ...
            const fireCount = wildfireByCounty.get(countyGEOID) || 0;
            layer.setStyle({
